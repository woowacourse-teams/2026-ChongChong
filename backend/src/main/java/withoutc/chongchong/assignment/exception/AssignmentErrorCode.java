...
public enum AssignmentErrorCode implements ErrorCode {
    ...
    INVALID_LINK(HttpStatus.BAD_REQUEST, "INVALID_LINK", "과제 링크가 올바르지 않습니다."),
    ...
    ASSIGNMENT_SUBMISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "ASSIGNMENT_SUBMISSION_NOT_FOUND", "존재하지 않는 제출물입니다."),
