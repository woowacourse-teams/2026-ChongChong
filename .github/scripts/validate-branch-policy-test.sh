...
expect_pass "app/feat/290-login" "dev"
expect_pass "app/fix/login" "dev"
expect_pass "app/chore/290-branch-label-policy" "dev"
expect_pass "app/release-candidate/290-preview" "dev"
expect_pass "common/chore/coderabbit" "dev"
expect_pass "be/infra/83-ci-cd-pipeline" "dev"
expect_pass "common/hotfix/policy" "dev"
expect_pass "fe/release-candidate/12-preview" "dev"
expect_pass "dev" "prod"

expect_fail "fe/feat/12-login" "prod"
expect_fail "be/fix/login" "prod"
expect_fail "app/feat/290-login" "prod"
expect_fail "app/feat/290-login" "main"
expect_fail "app/dev" "dev"
expect_fail "app/Feature/login" "dev"
expect_fail "app/feat/0-login" "dev"
expect_fail "app/feat/290-login_screen" "dev"
...
expect_fail "be/ci_cd/pipeline" "dev"
expect_fail "common/1infra/policy" "dev"
expect_fail "common/-infra/policy" "dev"
